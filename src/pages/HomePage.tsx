...
import AISubjectFeature from '../components/AISubjectFeature';
      ...
      <div className="container mx-auto px-6 py-16 relative z-10 mt-8">
        ...
        >
          ...
          <div className="flex flex-wrap justify-center gap-4">
            <motion.button 
              className="px-8 py-4 bg-gradient-to-r from-[#8494FF] to-[#6A78DB] rounded-xl text-white font-bold shadow-xl"
              whileHover={{ scale: 1.05, boxShadow: "0 15px 30px rgba(132, 148, 255, 0.4)" }}
              whileTap={{ scale: 0.95 }}
            >
              Start Free Trial
            </motion.button>
            <motion.button 
              className="px-8 py-4 bg-gradient-to-r from-[#E68A49] to-[#DD6B2D] rounded-xl text-white font-bold shadow-xl"
              whileHover={{ scale: 1.05, boxShadow: "0 15px 30px rgba(230, 138, 73, 0.4)" }}
              whileTap={{ scale: 0.95 }}
            >
              View Pricing
            </motion.button>
          </div>
          <p className="mt-6 text-[#F2F2FF]/70">
            Join thousands of students revolutionizing how they learn
          </p>
        </motion.div>
      </div>
