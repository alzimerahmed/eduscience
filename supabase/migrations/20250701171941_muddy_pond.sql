/*
  ...
  1. New Tables
    - Seed initial sample data for papers and questions
    - Add proper enum type casting for question_type and difficulty_level
    - Provide sample user progress data
*/
        ...
        IF question_count = 0 THEN
            ...
            FOR i IN 1..5 LOOP
                INSERT INTO questions (
                    ...
                    END,
                    CASE 
                        WHEN i = 1 OR i = 3 OR i = 5 THEN 'essay'::question_type
                        WHEN i = 2 THEN 'calculation'::question_type
                        ELSE 'short-answer'::question_type
                    END,
                    CASE 
                    ...
                    END,
                    CASE 
                        WHEN i IN (1, 3) THEN 'medium'::difficulty_level
                        WHEN i = 5 THEN 'hard'::difficulty_level
